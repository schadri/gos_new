...
import { User, Menu, LogOut, Bell, LifeBuoy, ShieldCheck, Monitor, Coins, Zap } from 'lucide-react'
            ...
            <nav className="flex items-center space-x-6 text-sm font-medium">
              ...
              {role === 'employer' ? (
                <>
                  ...
                  {isWindows && (
                    <Link href="/GOS_Instalador.zip" className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-primary/10 text-primary hover:bg-primary/20 transition-all font-bold text-xs ring-1 ring-primary/20">
